package com.chrysalis.database.provider;

import com.chrysalis.database.MyDBHandler;
...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.chrysalis.database.provider.MyContentProvider";
